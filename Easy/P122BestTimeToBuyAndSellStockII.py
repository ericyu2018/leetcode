...
File Name :   P122BestTimeToBuyAndSellStockII.py
...
class P122BestTimeToBuyAndSellStockII(object):
...
if __name__ == '__main__':
    print(P122BestTimeToBuyAndSellStockII().max_profit([7, 1, 5, 3, 6, 4]))
    print(P122BestTimeToBuyAndSellStockII().max_profit([1, 2, 3, 4, 5]))
    print(P122BestTimeToBuyAndSellStockII().max_profit([7, 6, 4, 3, 1]))
